...
function Weapon(game, player, type, rarity, ability, spawn) {
    ...
    else if (ability >= 3) {} else this.ability = false;
...
function Frump(game) {
    ...
    this.anim.dash = new Animation(ASSET_MANAGER.getAsset('./img/entities/frump.png'), 0, 1600, 200, 200, 0.055, 5, false, false);
